...
class CategoryAutocomplete {
    ...
    showDropdown(input) {
        ...
        // Add inline styles to ensure visibility (position will be set in positionDropdown)
        this.currentDropdown.style.backgroundColor = 'white';
        this.currentDropdown.style.border = '1px solid #ddd';
        this.currentDropdown.style.borderRadius = '4px';
        this.currentDropdown.style.boxShadow = '0 2px 8px rgba(0, 0, 0, 0.1)';
        ...
        categoriesToShow.forEach(category => {
            ...
            if (query) {
                ...
                item.innerHTML = category.replace(regex, '<mark>$1</mark>');
            } else {
        ...
        setTimeout(() => {
            if (this.currentDropdown) {
                this.currentDropdown.style.backgroundColor = 'yellow';
                this.currentDropdown.style.border = '2px solid red';
