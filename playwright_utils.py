...
async def click_text_in_page(page: Page, text_to_click: str) -> tuple[int, int] | None:
    ...
    if ocr_results:
        for result in ocr_results:
            ...
            click_x, click_y = await get_scaled_coordinate(click_point["x"], click_point["y"], page)
